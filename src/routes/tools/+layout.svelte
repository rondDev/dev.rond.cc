			...
			{#if !isBase}
				<Sidebar {activeUrl} class="min-h-full">
					<SidebarWrapper class="h-full rounded-xl">
						<SidebarBrand {site} />
						<SidebarGroup>
							<SidebarItem label="Base64" href="{base}/tools/encode-decode/base64">
								<svelte:fragment slot="icon">
									<Base64 />
								</svelte:fragment>
							</SidebarItem>
							<SidebarItem label="Hex" href="{base}/tools/converters/hex">
								<svelte:fragment slot="icon">
									<Hex />
								</svelte:fragment>
							</SidebarItem>
						...
						<SidebarGroup border>
							<SidebarItem label="MD5" href="{base}/tools/hash/md5">
								<svelte:fragment slot="icon">
									<Md5 />
								</svelte:fragment>
							</SidebarItem>
							<SidebarItem label="SHA1" href="{base}/tools/hash/sha1">
								<svelte:fragment slot="icon">
									<Sha1 />
								</svelte:fragment>
							</SidebarItem>
						...
						<SidebarGroup border>
							<SidebarItem label="URL" href="{base}/tools/encode-decode/url">
								<svelte:fragment slot="icon">
									<Url />
								</svelte:fragment>
							</SidebarItem>
							<SidebarItem label="JWT" href="{base}/tools/encode-decode/jwt">
								<svelte:fragment slot="icon">
									<Jwt />
								</svelte:fragment>
							</SidebarItem>
						...
						<SidebarGroup border>
							<SidebarItem label="Text Case" href="{base}/tools/text-manipulation/textcase">
								<svelte:fragment slot="icon">
									<TextCase />
								</svelte:fragment>
							</SidebarItem>
							<SidebarItem label="Whitespace" href="{base}/tools/text-manipulation/whitespace">
								<svelte:fragment slot="icon">
									<Whitespace />
								</svelte:fragment>
							</SidebarItem>
			...
			{:else}
				<div id="container" class="w-full flex flex-col items-center select-none">
					...
					<div id="cards" class="w-full grow grid grid-cols-4 grid-rows-2 p-16 gap-8">
						<Card href="{base}/tools/encode-decode/base64">
						...
						<Card href="{base}/tools/converters/hex">
